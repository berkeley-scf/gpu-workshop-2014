...
# 4) Random Number Generation (RNG) on the GPU
...
### 4.3) Calling CURAND from C and from Python
...
To choose the generator in C (in particular the Mersenne Twister), this should work:
